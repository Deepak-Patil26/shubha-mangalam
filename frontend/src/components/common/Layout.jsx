  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      >
              ...
              <div className="relative">
                ...
                <div className="relative w-10 h-10 md:w-12 md:h-12 rounded-full bg-gradient-to-br from-primary-maroon to-primary-gold flex items-center justify-center shadow-lg shadow-primary-gold/20 group-hover:scale-105 transition-transform duration-300">
                  <img
                    ...
                    className="h-8 w-auto md:h-10 object-contain group-hover:scale-105 transition-transform duration-300"
                  />
                </div>
              </div>
              <div className="hidden xs:block">
                <h1 className="text-lg md:text-2xl font-bold gradient-text group-hover:scale-105 transition-transform duration-300 leading-tight">
                  Shubha Mangalam
                </h1>
            ...
            <div className="flex items-center space-x-2 md:space-x-4 flex-shrink-0">
              ...
              <div className="relative hidden md:block">
                <button
                  ...
                  className="flex items-center space-x-2 px-2 py-2 rounded-xl hover:bg-gray-100 transition-all duration-300 border border-transparent hover:border-primary-gold/20"
                >
                  <FaGlobe className="text-primary-maroon" />
                  <span className="text-sm font-medium hidden md:inline">
                    EN
                  </span>
                  <FaChevronDown className="text-xs text-text-light hidden md:inline" />
                </button>
              </div>
              ...
              <button
                ...
                className="lg:hidden p-1.5 md:p-2 rounded-xl text-text-dark hover:text-primary-maroon hover:bg-primary-maroon/5 transition-all duration-300 ml-1"
              >
                {mobileMenuOpen ? (
        ...
        {/* Mobile Menu - Fixed with better spacing */}
        {mobileMenuOpen && (
        ...
        <div className="container mx-auto px-4 py-12 md:py-16 relative z-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-10">
            ...
            <div className="sm:col-span-2 lg:col-span-1.5">
              ...
              <div className="flex space-x-3 md:space-x-4 mt-4 md:mt-6">
                <a
                  href="#"
                  className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-white/5 hover:bg-primary-gold/20 border border-white/10 hover:border-primary-gold/30 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-primary-gold/20"
                >
                  <FaFacebook className="text-gray-400 hover:text-primary-gold transition-colors text-sm md:text-base" />
                </a>
                <a
                  href="#"
                  className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-white/5 hover:bg-primary-gold/20 border border-white/10 hover:border-primary-gold/30 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-primary-gold/20"
                >
                  <FaInstagram className="text-gray-400 hover:text-primary-gold transition-colors text-sm md:text-base" />
                </a>
                <a
                  href="#"
                  className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-white/5 hover:bg-primary-gold/20 border border-white/10 hover:border-primary-gold/30 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-primary-gold/20"
                >
                  <FaTwitter className="text-gray-400 hover:text-primary-gold transition-colors text-sm md:text-base" />
                </a>
                <a
                  href="#"
                  className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-white/5 hover:bg-primary-gold/20 border border-white/10 hover:border-primary-gold/30 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-primary-gold/20"
                >
                  <FaYoutube className="text-gray-400 hover:text-primary-gold transition-colors text-sm md:text-base" />
                </a>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 md:space-y-3 text-sm text-gray-400">
                <li className="flex items-center gap-3 group hover:text-primary-gold transition-colors duration-300 text-sm">
          ...
          <div className="border-t border-white/5 mt-8 md:mt-12 pt-6 md:pt-8 flex flex-col md:flex-row justify-between items-center gap-3 md:gap-4">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 md:gap-6 text-[10px] md:text-xs text-gray-500">
              ...
              <span className="w-px h-3 md:h-4 bg-gray-700"></span>
              <Link
                to="/terms"
                className="hover:text-primary-gold transition-colors duration-300"
              >
